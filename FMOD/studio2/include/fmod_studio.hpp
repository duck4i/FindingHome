...
namespace Studio
{
    ...
    inline FMOD_RESULT parseID(const char* idString, ID* id) { return FMOD_Studio_ParseID(idString, id); }

    class System : public Handle<System>
    {
    public:
        static FMOD_RESULT F_API create(System* system);                                                            // Creates a system
        ...
        // Listener control
        FMOD_RESULT F_API getListenerAttributes(FMOD_STUDIO_3D_ATTRIBUTES* attributes) const;
        FMOD_RESULT F_API setListenerAttributes(const FMOD_STUDIO_3D_ATTRIBUTES* attributes);

        FMOD_RESULT F_API loadBank(const char* filename, Bank* bank);                                       // Load a bank file in full. Wraps bank registration and loading.

        FMOD_RESULT F_API registerPlugin(const FMOD_DSP_DESCRIPTION2* description);
    ...
    public:
        ...
        FMOD_RESULT F_API get3DAttributes(FMOD_STUDIO_3D_ATTRIBUTES* attributes) const;
        FMOD_RESULT F_API set3DAttributes(const FMOD_STUDIO_3D_ATTRIBUTES* attributes);
        ...
        FMOD_RESULT F_API getNumCues(int* numCues) const;
