...
struct FMOD_STUDIO_EVENT_INSTANCE;

typedef enum
{
    FMOD_STUDIO_EVENT_CALLBACK_STARTED,                     // Called when an instance starts. Parameters = FMOD_STUDIO_EVENT_INSTANCE.
    FMOD_STUDIO_EVENT_CALLBACK_STOPPED,                     // Called when an instance stops. Parameters = FMOD_STUDIO_EVENT_INSTANCE.
    FMOD_STUDIO_EVENT_CALLBACK_STOLEN,                      // Called when an instance is stopped by "steal oldest" or "steal quietest" behaviour. Parameters = FMOD_STUDIO_EVENT_INSTANCE.
...
typedef struct
{
    ...
    FMOD_STUDIO_EVENT_INSTANCE* event;  // The event instance that needs to play the sound.
