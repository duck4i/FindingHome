...
FMOD_RESULT F_API FMOD_System_GetDSPInfoByPlugin     (FMOD_SYSTEM *system, unsigned int handle, const FMOD_DSP_DESCRIPTION2 **description);
...
FMOD_RESULT F_API FMOD_System_RegisterDSP2           (FMOD_SYSTEM *system, const FMOD_DSP_DESCRIPTION2 *description, unsigned int *handle);
...
FMOD_RESULT F_API FMOD_System_CreateDSP              (FMOD_SYSTEM *system, const FMOD_DSP_DESCRIPTION2 *description, FMOD_DSP **dsp);
...
FMOD_RESULT F_API FMOD_DSP_RemoveSideChain           (FMOD_DSP *dsp, FMOD_DSP *source);
...
FMOD_RESULT F_API FMOD_DSPConnection_IsSideChain     (FMOD_DSPCONNECTION *dspconnection, FMOD_BOOL *issidechain);
