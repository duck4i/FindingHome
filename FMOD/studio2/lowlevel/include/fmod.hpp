    ...
    */
    ...
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getDSPInfoByPlugin     (unsigned int handle, const FMOD_DSP_DESCRIPTION2 **description);
        ...
        FMOD_RESULT F_API registerDSP2           (const FMOD_DSP_DESCRIPTION2 *description, unsigned int *handle);
        ...
        FMOD_RESULT F_API createDSP              (const FMOD_DSP_DESCRIPTION2 *description, DSP **dsp);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API removeSideChain        (DSP *source);
    ...
    */
    class DSPConnection
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setMixMatrix          (float *matrix, int outchannels, int inchannels, int inchannel_hop = 0);
        FMOD_RESULT F_API getMixMatrix          (float *matrix, int *outchannels, int *inchannels, int inchannel_hop = 0);
        FMOD_RESULT F_API isSideChain           (bool *issidechain);
